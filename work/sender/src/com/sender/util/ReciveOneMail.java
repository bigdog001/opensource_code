...
public class ReciveOneMail {
    ...
    private String saveAttachPath = "/home/bigdog/tmp/mailreceiver"; //附件下载后的存放目录
...
//        fileName = UIDGenerator.getUID();
    ...
    public static void main(String args[]) throws Exception {
        ...
        URLName url = new URLName("pop3", "pop.qq.com", 110, null,
                "294356967@qq.com", "11111111");
        ...
        try {
            ...
            for (int i = 0; i < message.length; i++,j--) {
                ...
                pmm.setAttachPath("/home/bigdog/tmp/");
