package  com.facemail.mobile.android.util.net.http;
...
import com.facemail.mobile.android.util.Variables;
import com.facemail.mobile.android.util.json.JsonObject;
import com.facemail.mobile.android.util.json.JsonParser;
import com.facemail.mobile.android.util.json.JsonValue;
import com.facemail.mobile.android.util.net.INetProvider;
import com.facemail.mobile.android.util.net.INetRequest;
import com.facemail.mobile.android.util.net.INetResponse;
import com.facemail.mobile.android.util.net.http.HttpProxy;
...
//					}
					try {
						...
						HttpHost host = HttpProxy.getProxyHttpHost(FaceMailApplication.getFaceMailContext());
						if (host != null) {
