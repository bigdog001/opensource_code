package com.facemail.server.mobile.util;
...
public class Tools {
    public static InputStream getInputStream() {
        ...
        obj.put(Config.error_codeName, Config.error_code_emptyRequestParameter);
        obj.put(Config.error_MsgName, Config.error_code_emptyRequestParameterMsg);
    ...
    public static String getValueByKey(String language1, String language2, String key) {
        ...
        if (!"".equals(language1) && !"".equals(language2) && language1 != null & language2 != null && !"".equals(key) && key != null) {
            ...
            ResourceBundle messages = ResourceBundle.getBundle(Config.getAppParams().getProperty("messageFile"), locale);
