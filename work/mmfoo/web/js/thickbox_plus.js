...
function TB_show(caption, url) { //function called when the user clicks on a thickbox link
    try {
        ...
        if (urlType == '.htm' || urlType == '.html') {//code to show html pages
            ...
            $("#TB_window").append("<div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton'>关闭</a></div><div id='TB_ajaxContent' style='width:" + ajaxContentW + "px;height:" + (ajaxContentH +75)+ "px;'></div>");
            $("#TB_closeWindowButton").click(TB_remove);
