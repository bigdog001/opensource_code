...
<html>
   ...
   <script type="text/javascript">
		...
		window.onload = function() {
			upload1 = new SWFUpload({
				// Backend Settings
				upload_url: "PictureAction.action", //这里的action不可以删除
				post_params: {"picSESSID" : "songhao"},
				file_post_name: "file",
				// File Upload Settings
				file_size_limit : "102400",	// 100MB  //文件大小设定
				file_types : "*.gif;*.jpg;*.pdf;*.ppt",//文件上传类型现在
  ...
  <div id="content">
	<h2>上传文档</h2>
    <s:form action="PictureAction" method="post" name="thisform" namespace="/" enctype="multipart/form-data">
    	<p>本界面只能上传doc、txt、ppt、pdf文件</p>
		<table>
			<tr valign="top">
				<td>
					<div>
