...
import com.bigdog.mobile.android.Interphone.net.NetTcpFileReceiveThread;
import com.bigdog.mobile.android.Interphone.net.NetThreadHelper;
					 ...
					 .setNegativeButton("取消", 
							 new DialogInterface.OnClickListener() {
						 		public void onClick(DialogInterface dialog, int which) {
									...
									ipmsgSend.setSenderName("android对讲机");
