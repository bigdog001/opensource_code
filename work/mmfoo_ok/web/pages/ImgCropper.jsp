...
<c:choose>
    ...
    <c:otherwise>
        ...
        <input type="button" value="使之生效并预览" onclick="javascript:getrec()"/>
        <input type="text" id="vvvv" style="width: 200px;">
        <img src="" id="pic_cuted">
    </c:otherwise>
</c:choose>
<input type="button" value="上传"
       onclick="javascript:window.open('/pages/upload.jsp','_blank','height=200, width=370, top=100, left=500, toolbar=no, menubar=no, scrollbars=yes,resizable=no,location=no, status=no');">
<br><br><br>
