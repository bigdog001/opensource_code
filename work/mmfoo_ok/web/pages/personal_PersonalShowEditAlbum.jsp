...
<div id="main_body">
<div class="bjda_bt" style="text-align:right;"><a href="<%=basePath%>/usershow-${user_id_userspace}-3.html">返回我的展示</a></div>
<div class="mfzs_psea">
    <%-- 根据相册的id取相册对象 --%>
...
<table width="100%" height="250" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="233" rowspan="4" valign="top">
        <%-- 取封面 --%>
         <mfo:getSetFace setid="${user_setid_userspace}" />

        <img src="<%=basePath%>/images/<c:choose><c:when test="${empty setface.thumb_img}">meinv8.jpg</c:when><c:otherwise>${setface.thumb_img}</c:otherwise></c:choose>
                <c:out value=""/>" width="233" height="247" />
    </td>
    <td width="10" rowspan="4" valign="top"></td>
    <td width="80" height="30" align="right" class="fB">名字：</td>
    <td><input type="text" id="setname" name="" value="${imgsetsingle.setname}"/></td>
  </tr>
  <tr>
    <td width="80" height="30" align="right" valign="top" class="fB">描述：</td>
    <td><textarea id="setdiscribe">${imgsetsingle.setdiscribe}</textarea></td>
  </tr>
 <%-- <tr>
  ...
  <tr>
    ...
    <td>
    <input  type="button" class="bn_bn" value="保存" src="<%=basePath%>/images/bn_bcxg.gif" onclick="saveImgsetEdit('${user_setid_userspace}')"/>&nbsp;&nbsp;&nbsp;
    <input  type="button" class="bn_bn" value="取消" src="<%=basePath%>/images/bn_qx.gif" onclick="window.location='<%=basePath%>/usershow-${user_id_userspace}.html'"/>
    </td>
  </tr>
</table>
</form>
