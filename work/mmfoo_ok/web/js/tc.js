...
;
var m_c = get("tc_zzjs_net"),t,urls;
if (urls != null) {
...
if (m_c == null) {
    ...
    if (typeof(url) == 'undefined') {
        var url = "http://www.zzjs.net/ad/tc.html";
    }
    ;
    var num = 1,stp_c = false,use = false,myurl = location.href + '/',max_t = 20,atx_t = false,tried = 0,key = '0',m_win,pop_w,sas = 0;
    ...
    ;
    function v_o() {
        var os = 'W0',bs = 'I0',i_f = false,bro = window.navigator.userAgent;
