...
if(dialogFirst==true){
  ...
  temp_float+="<div class=\"title\"><h4></h4><span><!--X--></span></div>";
  temp_float+="<div class=\"content\" id='contentcc'></div>";
  temp_float+="</div>";
  ...
  dialogFirst=false;
   ...
   $("#floatBox .title span").click(function(){
    ...
    $("#contentcc").html("");
    $("#floatBox").hide(600);
       $("#mailchk").attr("href","javascript:showdialog()");
  }); 
}
...
$("#floatBox").css({display:"block",left:(($(document).width())/2-(parseInt(width)/2))+"px",top:($(document).scrollTop()+100)+"px",width:width,height:height});
}