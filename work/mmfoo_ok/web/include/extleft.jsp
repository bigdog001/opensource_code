...
<ul>
    <li  <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><span><a href="<%=basePath%>/ext-1.html">什么是美分</a></span></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-2.html">美分团队</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-3.html">加入我们</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-4.html">市场与商业合作</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-5.html">合作链接</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-6.html">联系方式</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-7.html">投资与资本</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-8.html">在线客服</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-9.html">防骗说明</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-10.html">美分声明</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-11.html">隐私政策</a></c:otherwise>
        </c:choose>
    ...
    <li <c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise><a href="<%=basePath%>/ext-12.html">使用条款</a></c:otherwise>
        </c:choose>
